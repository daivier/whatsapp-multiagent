---
title: "8 métricas de atendimento que todo gestor deveria acompanhar"
description: "As principais métricas de atendimento no WhatsApp — do tempo de primeira resposta à satisfação — e como usá-las para melhorar a operação."
slug: metricas-de-atendimento
...
Quanto a equipe demora para dar o primeiro retorno. É uma das métricas que mais pesam na satisfação. Se estiver alto, veja [como reduzir o tempo de primeira resposta](/blog/reduzir-tempo-primeira-resposta.html).
...
Quantas conversas estão aguardando atendimento. Esse número deveria tender a zero ao fim do expediente. Se cresce, há problema de capacidade ou de [distribuição](/blog/distribuicao-de-conversas-equipe.html).

## 6. Cumprimento de SLA

O percentual de atendimentos dentro das metas definidas. É o termômetro do seu [acordo de nível de serviço](/blog/sla-de-atendimento-whatsapp.html): se cai, investigue a causa antes que o cliente perceba.
...
A nota que o cliente dá ao atendimento. É a métrica que conecta todas as outras ao que realmente importa: o cliente saiu satisfeito? Uma pergunta simples no [encerramento da conversa](/blog/respostas-rapidas-whatsapp.html) já coleta esse dado.
...
Quer acompanhar tudo isso em relatórios automáticos? [Faça um teste gratuito](/#planos).
