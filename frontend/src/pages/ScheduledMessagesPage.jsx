...
const S = {
  ...
  contactInfo: { display: 'flex', flexDirection: 'column', gap: '1px', minWidth: 0 },
  contactName: { fontSize: '0.88rem', fontWeight: 600, color: 'var(--text)' },
  phone: { fontSize: '0.75rem', color: 'var(--hint)' },
